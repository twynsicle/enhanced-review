...
import { extractChapterTitles } from './partial-narrative-parse';
...
describe('extractChapterTitles', () => {
  ...
  it('does not pick up the prTitle as a chapter title', () => {
    // prTitle comes before chapters; the parser scopes to after `"chapters":[`.
