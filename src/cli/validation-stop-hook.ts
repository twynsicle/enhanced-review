...
import { fatalFindings } from '../review/findings.ts';
 ...
 * failing the run and making a person start it again, so validation runs here,
 ...
 *
 * Imports the SDK for types only, so building a hook does not load the SDK.
 */
