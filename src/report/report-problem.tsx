...
import { BUNDLE_SCHEMA_VERSION } from '@/review/bundle';
      ...
      return {
        ...
        body: (
          <>
            ...
            <Code>er review</Code>, or run <Code>npm run report:dev</Code> for the sample.
          </>
        ),
      };
  }
...
/**
 * What a reader sees when the reader itself throws, from `report-root.tsx`'s boundary.
 *
