...
import type { Diagram } from '@/review/diagram';
import { REAL_ARCHITECTURE, REAL_SEQUENCE, REAL_STATE } from '@/report/test/diagram-fixtures';
import { render } from '@/report/test/render';
