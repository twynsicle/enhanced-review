...
import type { DiffChunk } from '@/review/narrative';
import { EmbeddedFileSource } from '@/report/reader/file-source';
import { DisplayMenu } from '@/report/chrome/display-menu';
import { useDiffView } from '@/report/stores/diff-view';
import { DIFF_WRAP_KEY, useDiffWrap } from '@/report/stores/diff-wrap';
import { act, render, screen, userEvent, waitFor } from '@/report/test/render';
...
function wrapAfterRehydrate(stored: string | null): string {
  ...
  void useDiffWrap.persist.rehydrate();
...
describe('the wrap toggle', () => {
  ...
  // The reload: nothing but the stored word, rehydrated as the store loads
  // and followed by every editor on the page.
