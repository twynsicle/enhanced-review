...
**Status:** planning. **Branch:** `migrate-react-router`, cut from `main` (`d63b87c`).
...
| A9  | **Lint:** flat ESLint with `typescript-eslint`, `eslint-plugin-react-hooks`, `eslint-config-prettier`. `eslint-config-next` removed.                                                                                                                                                                                                                                                                                                                                                                  |
...
| A12 | **Server-only marker:** React Router's `.server.ts` filename convention replaces `import 'server-only'`. Domain/db code is server-only by construction (guardrail A4f).                                                                                                                                                                                                                                                                                                                               |
